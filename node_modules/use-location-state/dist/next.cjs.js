...
function useHashQueryStringInterface(_a) {
    ...
    var _d = react.useState(0), setR = _d[1];
...
function useIsValidQueryStateValue(value) {
    var defaultQueryStateValue = react.useMemo(function () { return queryStateCore.toQueryStateValue(value); }, [value]);
    ...
    return {
        ...
        setQueryString: function (newQueryString, _a) {
            ...
            new Promise(function (resolve, reject) {
                ...
                .then(function () {
                router$1[method](router$1.pathname + '?' + newQueryString);
            })
                .catch(function () {
