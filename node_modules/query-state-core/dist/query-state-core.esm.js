...
function parseQueryState(queryString) {
    ...
    params.forEach(function (value, key) {
        if (key in queryState.constructor.prototype) {
            return console.warn("parseQueryState | invalid key \"".concat(key, "\" will be ignored"));
        }
...
function createMergedQuery() {
    ...
    var mergedQueryStates = Object.assign.apply(Object, __spreadArray([{}], queryStates, false));
